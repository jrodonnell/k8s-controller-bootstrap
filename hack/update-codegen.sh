...
MODULE="TODO" # e.g. github.com/the-gizmo-dojo/g8s
GROUP_NAME="TODO" # e.g. api.g8s.io

SCRIPT_ROOT=$(dirname "${BASH_SOURCE[0]}")/..
API_ROOT="${MODULE/pkg/apis/$GROUP_NAME/v1alpha1}"
...
kube::codegen::gen_register \
    --input-pkg-root ${API_ROOT} \
    --output-pkg-root ${API_ROOT} \
...
kube::codegen::gen_client \
    --with-watch \
    --input-pkg-root ${API_ROOT} \
    --output-pkg-root ${SCRIPT_ROOT}/pkg/generated \
    --output-base "$(dirname "${BASH_SOURCE[0]}")/../../../.." \
    --boilerplate "${SCRIPT_ROOT}/hack/boilerplate.go.txt"
